...
const BrandPanel: React.FC<BrandPanelProps> = ({ 
  ...
  subheadline = 'Envía, recibe y paga en segundos. Una billetera pensada para tu día a día.'
}) => {
  return (
    <div 
    ...
    >
      ...
      <div className="flex flex-col gap-[18px] items-start not-italic relative shrink-0 w-full mb-auto mt-[238px]">
        <div className="font-bold leading-[1.08] relative shrink-0 text-[44px] text-white w-full whitespace-pre-wrap">
          {headline}
        </div>
